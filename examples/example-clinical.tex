...
% Dummy bib
\begin{filecontents}[overwrite]{example-clinical.bib}
@article{clarity2023,
...
\end{filecontents}
\addbibresource{example-clinical.bib}
...
\begin{frame}{Primary and Key Secondary Endpoints}
  \epcard{Primary: CDR-SB Change at 18 Months}
    {$-0.45$}{$-0.67,\;-0.23$}{$< .001$}
  \vskip6pt
  \epcard{Secondary: ADAS-Cog14 Change}
    {$-1.44$}{$-2.92,\;0.04$}{.056}
  \vskip6pt
  \epcard{Secondary: ADCS-MCI-ADL Change}
    {$-2.0$}{$-3.5,\;-0.5$}{.009}
\end{frame}
